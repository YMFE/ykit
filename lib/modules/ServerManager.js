...
module.exports = {
    ...
    getCompiler: function getCompiler(projectConfig, shouldCompileAllEntries, reqUrl, callback) {
        var webpackConfig = extend(true, {}, projectConfig);
        var entries = extend(true, {}, webpackConfig.entry);
        ...
        var isExtractTextPluginExists = webpackConfig.plugins.some(function (plugin) {
        ...
        // 返回 compiler
        var compiler = extend(webpack(webpackConfig), { entryNum: (0, _keys2.default)(webpackConfig.entry).length });
        callback(compiler);
    }
};