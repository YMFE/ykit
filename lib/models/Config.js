...
var Config = function () {
    function Config(cwd, configFile) {
        ...
        this._config = {
            ...
            plugins: [
            // local plugin
            require('../plugins/extTemplatedPathPlugin.js'), require('../plugins/requireModulePlugin.js'), require('../plugins/hashPlaceholderPlugin.js'), new CaseSensitivePathsPlugin(), new ExtractTextPlugin({ filename: 'css/[name].min.css', allChunks: true })],
            resolve: {
