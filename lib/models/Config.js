...
var _require = require('./constans'),
    extraConfig = _require.extraConfig;
...
var Config = function () {
    function Config(cwd, configFile) {
        ...
        this._config = {
            ...
            require('../plugins/hashPlaceholderPlugin.js'), new CaseSensitivePathsPlugin()],
            resolve: {
    ...
    (0, _createClass3.default)(Config, [{
        ...
        key: 'removeCustonConfig',
        value: function removeCustonConfig(config) {
            var __extraConfig = extraConfig(this.cwd);
            var __extraKey = (0, _keys2.default)(__extraConfig);
            var __config = extend({}, config);
            for (var key in __config) {
