...
var Config = function () {
    function Config(cwd, configFile) {
        ...
        this._config = {
            ...
            plugins: [require('../plugins/extTemplatedPathPlugin.js'), require('../plugins/requireModulePlugin.js'), require('../plugins/hashPlaceholderPlugin.js'), new webpack.HashedModuleIdsPlugin(), new CaseSensitivePathsPlugin()],
            resolve: {
                root: [],
