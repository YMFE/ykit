...
var Config = function () {
    function Config(cwd, configFile) {
        ...
        this._config = extend({
            ...
            plugins: [require('../plugins/extTemplatedPathPlugin.js'), require('../plugins/requireModulePlugin.js'), require('../plugins/hashPlaceholderPlugin.js'), new CaseSensitivePathsPlugin(), new webpack.HashedModuleIdsPlugin(), new webpack.optimize.ModuleConcatenationPlugin(), new extend(HappyPack({
                loaders: [{
