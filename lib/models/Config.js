...
var Config = function () {
    function Config(cwd, configFile) {
        ...
        this._config = extend({
            ...
            plugins: [require('../plugins/extTemplatedPathPlugin.js'), require('../plugins/requireModulePlugin.js'), require('../plugins/hashPlaceholderPlugin.js'), new webpack.HashedModuleIdsPlugin(), new CaseSensitivePathsPlugin(), new HappyPack({
                loaders: [{
                    ...
                    query: {
                        cacheDirectory: true,
                        presets: [[require.resolve('babel-preset-es2015'), { "modules": false }], require.resolve('babel-preset-es2016'), require.resolve('babel-preset-es2017'), require.resolve('babel-preset-stage-0')],
                        plugins: []
                    }
                }],
                threads: 4,
