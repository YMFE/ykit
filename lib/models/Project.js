        ...
        value: function readConfig() {
            ...
            this.plugins.map(function (pluginItem) {
                ...
                if (fs.existsSync(pluginPath)) {
                    ...
                    // 如果是打包阶段，直接中断
                    _this2._getCurrentEnv() !== 'local' && process.exit(1);
                }
            });
            ...
            if (ykitConfigFile && ykitConfigFile.config) {
                ...
                // 兼容以前从 options 传进去 ExtractTextPlugin
                ? ykitConfigFile.config({ ExtractTextPlugin: ExtractTextPlugin }, this.cwd) : ykitConfigFile.config;
            ...
            */
            ...
            function handleFilename(filename, tpl) {
                ...
                var filepaths = path.parse(filename),
                    newtpl;
