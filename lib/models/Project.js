    ...
    (0, _createClass3.default)(Project, [{
        ...
        value: function fixCss() {
            var config = this.config.getConfig(),
                ...
                cssExtNames = ENTRY_EXTNAMES.css,
                fps = [];
        ...
        value: function moveSourcemap() {
            ...
            this.packCallbacks.push(function (opt, stats) {
                ...
                if (opt.min) {
                    ...
                    globby(mapPattern, { expandDirectories: true }).then(function (files) {
                        logInfo('扫描发现 map 文件有', files);

                        _promise2.default.all(files.map(function (filePath) {
        ...
        value: function _getLintFiles(dir, fileType) {
            var context = this.config._config.context,
                extNames = ENTRY_EXTNAMES[fileType],
