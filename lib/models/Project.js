        ...
        value: function readConfig(options) {
            ...
            if (this.check()) {
                ...
                if (this.extendConfig != 'config') {
                    (function () {
                        var moduleName = 'ykit-config-' + _this2.extendConfig,
                            modulePath = '';

                        var localSearchPath = sysPath.join(_this2.cwd, 'node_modules/', moduleName);
                        var localSearchPathQnpm = sysPath.join(_this2.cwd, 'node_modules/', '@qnpm/' + moduleName);
                        ...
                        _this2.ignores.push(Manager.loadIgnoreFile(modulePath));
                        ...
                        if (fs.existsSync(modulePath)) {
                            ...
                            if (item) {
                                ...
                                if (_this2.extendConfig) {
                                    warn('没有找到 ykit-config-' + _this2.extendConfig + ' 配置模块！');
                                }
                            }
                        }
                    })();
                ...
                if (configMethod) {
                    ...
                    if (typeof configMethod.config === 'function') {
                        _handleConfigObj.bind(this)(configMethod.config.call(userConfig, options, this.cwd));
