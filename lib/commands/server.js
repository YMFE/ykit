...
exports.run = function (options) {
    ...
    app.use(function (req, res, next) {
        ...
        var shouldCompileAllEntries = webpackConfig.plugins.some(function (plugin, i) {
        ...
        if (!shouldCompileAllEntries || allAssetsEntry[projectName] === url) {
            ServerManager.getCompiler(project.config._config, shouldCompileAllEntries, url, function (compiler) {
