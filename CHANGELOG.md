<a name="0.2.0"></a>
# [0.2.0](http://gitlab.corp.qunar.com/mfe/ykit/compare/0.2.0-rc3...v0.2.0) (2016-12-16)



<a name="0.2.0-rc3"></a>
# [0.2.0-rc3](http://gitlab.corp.qunar.com/mfe/ykit/compare/0.2.0-rc1...0.2.0-rc3) (2016-12-15)
...
<a name="0.2.0-rc1"></a>
# [0.2.0-rc1](http://gitlab.corp.qunar.com/mfe/ykit/compare/0.2.0-rc0...0.2.0-rc1) (2016-12-15)
...
<a name="0.2.0-rc0"></a>
# [0.2.0-rc0](http://gitlab.corp.qunar.com/mfe/ykit/compare/0.1.7...0.2.0-rc0) (2016-12-14)
...
* **init:** 初始化改为只生成一个空工程 ([ab08750](http://gitlab.corp.qunar.com/mfe/ykit/commit/ab08750))
* **init:** 初始化模板文件改为 ykit.js ([48b979e](http://gitlab.corp.qunar.com/mfe/ykit/commit/48b979e))
...
* **init:** 提供初始化模板 ([a3b8814](http://gitlab.corp.qunar.com/mfe/ykit/commit/a3b8814))
