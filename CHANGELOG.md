...
* **config:** 不在寻找全局插件（使用 npm_cache_share) 做缓存策略 (+1 squashed commit) ([cf95818](http://gitlab.corp.qunar.com/mfe/ykit/commit/cf95818))
...
* **compile:** 强制模块路径大小写正确 ([0175e78](http://gitlab.corp.qunar.com/mfe/ykit/commit/0175e78))
