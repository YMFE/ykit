;(function(global){
    ...
    overlay.style.cssText = 'display: none; position:absolute; left: 0; right: 0; top: 0; bottom: 0; padding: 15px;'
                          + 'opacity: 0.85; z-index: 99999999; line-height: 20px; word-wrap: break-word; overflow: auto;'
    ...
    socket.on('testAppID', function(assetEntrys) {
        ...
        if(needRefreshment) {
            ...
            // 添加按钮
            var btnStyle = 'position: absolute; bottom: 70px; right: 15px; width: 100px; opacity: 0.9;'
            ...
            btnDismiss.onclick = function(){overlay.style.display = 'none';}
            ...
            fragment.appendChild(btnReload);
            fragment.appendChild(btnDismiss);
